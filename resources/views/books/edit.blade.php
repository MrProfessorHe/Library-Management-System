...
@section('content')
    <div class="min-h-screen bg-gray-100 dark:bg-gray-900 flex items-center justify-center px-4">
        <div class="w-full max-w-4xl p-8 bg-blue-50 dark:bg-gray-800 rounded-2xl shadow-2xl text-gray-800 dark:text-gray-100">
            ...
            <form action="{{ route('books.update', $book->id) }}" method="POST" class="grid gap-6 md:grid-cols-2">
                ...
                <div class="md:col-span-2 text-center mt-4">
                    <button type="submit"
                            class="bg-yellow-500 hover:bg-yellow-600 text-white font-semibold px-6 py-3 rounded-xl shadow-md transition-all">
                        Update Book
                    </button>
                </div>
            </form>
